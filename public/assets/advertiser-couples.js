...
async function renderCouplesForEvent(eventId, targetEl) {
  try {
    ...
    function personRow(person) {
      ...
      row.style.cssText = "display:flex;flex-direction:column;gap:2px;padding:4px 0;text-align:center";
      const name = document.createElement("span");
      name.style.cssText = "font-weight:800;font-size:18px;color:#fff";
    ...
    confirmed.forEach(([male, female], idx) => {
      ...
      pairBox.style.cssText = "display:flex;justify-content:space-around;gap:16px;flex-wrap:wrap;" +
        (idx > 0 ? "margin-top:12px;padding-top:12px;border-top:1px solid rgba(255,255,255,.12)" : "");
