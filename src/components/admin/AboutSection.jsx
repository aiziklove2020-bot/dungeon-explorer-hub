        ...
        {aboutData.infoCards && aboutData.infoCards.map((card, index) => (
          <div key={index} className="bg-black/40 border border-zinc-800 p-4 rounded-xl space-y-3">
            <input
              ...
              className="w-full bg-zinc-900 border border-zinc-700 p-2 rounded-lg focus:border-red-600 outline-none text-white text-right font-bold"
            ...
            <textarea
              ...
              rows={3}
              className="w-full bg-zinc-900 border border-zinc-700 p-2 rounded-lg focus:border-red-600 outline-none text-white text-right"
          ...
          <div key={index} className="bg-black/40 border border-zinc-800 p-4 rounded-xl space-y-3">
            <div className="flex gap-3">
              <input
                ...
                className="w-16 bg-zinc-900 border border-zinc-700 p-2 rounded-lg focus:border-red-600 outline-none text-white text-center font-bold"
              />
              <input
                type="text"
                value={step.t}
                ...
                className="flex-1 bg-zinc-900 border border-zinc-700 p-2 rounded-lg focus:border-red-600 outline-none text-white text-right font-bold"
                placeholder={t('admin.title')}
              />
            </div>
            <textarea
